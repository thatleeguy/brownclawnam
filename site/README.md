...
The original design pitch lives at `../pitch.html` and `../pitch-v1-design-reference.html` in the parent directory and is preserved unchanged. This Laravel app is the productionised version of that design.
...
- Connect Forge to the GitHub repo containing this `site/` directory.
...
The design reference is `../pitch.html` (and `../pitch-v1-design-reference.html` as the immutable archived copy). Keep them in sync philosophically; the live site is the source of truth.
